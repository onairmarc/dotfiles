...
Only the orchestration agent running `plan-execute`, including the `the-implementor` agent when it runs that workflow, may delete the consumed plan directory. It does so
