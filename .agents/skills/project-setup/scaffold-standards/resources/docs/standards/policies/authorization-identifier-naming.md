...
- {{GEN:state the segment convention this project uses — the separator, the casing of each segment, and the segment order (e.g. module, resource, action) — with a worked
  example. Ask the user; this is a project decision.}}
...
- {{GEN:where authorization identifier enums live given {{MODULE_LAYOUT}}, and how a new one is registered with the authorization system. Detect and confirm.}}
