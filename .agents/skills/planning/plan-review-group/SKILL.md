...
Read and follow `~/.claude/skills/delivery-constraints/SKILL.md`. No plan in the group is agent-ready unless it is structured as vertical slices, assumes the work lands in
...
Hold every plan against `~/.claude/skills/delivery-constraints/SKILL.md`. Every finding here is a blocker.
